...
/**
 * Special Thanks to <a>http://stackoverflow.com/questions/11659396/using-a-jprogressbar-with-saxparser</a>
 * A class that monitors the read progress of an input stream.
 * Note that this version does not have any of the AWT/Swing features from the original
 *
