...
public final class Validations {
	...
	/**
	 * Based on quava Preconditions.checkNotNull, but did not want to add a
	 * dependency
	 * 
	 * @param object
	 ...
	 *             with given message if given object is null
	 */
	 ...
	 *            Message for the potential NullPointerException
	 * @throws NullPointerException
	 *             with given message if both given objects are null
	 */
	...
	/**
	 * @param object1
	 *            Object to check for presence
	 * @param object2
	 *            Object to check for presence
	 * @param message
	 *            Message for the potential IllegalStateException
	 * @throws IllegalStateException
	 *             with given message if both given objects are present
	 */
